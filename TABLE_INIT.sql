...
INSERT INTO CHATROOM(CHATROOM_NO, PICNIC_NO, CHATROOM_KIND)
VALUES('CR' || LPAD(CHATROOM_NO_SQ.NEXTVAL, 8, '0'), 'PG00000001', 'G');
INSERT INTO CHATROOM(CHATROOM_NO, PICNIC_NO, CHATROOM_KIND)
VALUES('CR' || LPAD(CHATROOM_NO_SQ.NEXTVAL, 8, '0'), NULL, NULL);
...
-- CONSTRAINT BUY_RECORD_PK PRIMARY KEY(BR_ID));
...
-- MF_REPORTNUM      NUMBER(2) NOT NULL, 
-- CONSTRAINT MANUFACTURERS_PK PRIMARY KEY (MF_NO));
...
-- CONSTRAINT ADVERTISEMENT_PK PRIMARY KEY(AD_NO));
...
-- 權限明細.
-- CREATE TABLE PURVIEW_DETAILE(
-- ADM_NO                       VARCHAR2(10) NOT NULL,
-- PURVIEW_NO                   VARCHAR2(10) NOT NULL,
-- CONSTRAINT PURVIEW_DETAILE_ADMNO_FK FOREIGN KEY (ADM_NO) REFERENCES ADMINISTRATOR (ADM_NO),
-- CONSTRAINT PURVIEW_DETAILE_PURVIEWNO_FK FOREIGN KEY (PURVIEW_NO) REFERENCES PURVIEW (PURVIEW_NO),
-- CONSTRAINT PURVIEW_DETAILE_PK PRIMARY KEY (ADM_NO,PURVIEW_NO));
...
-- CONSTRAINT CHATROOM_MESSAGE_PRIMARY_KEY PRIMARY KEY(CHATROOM_NO,MEM_NO,MESSAGE_DATE));
