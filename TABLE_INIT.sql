...
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','電腦斷層掃描儀',SYSDATE,'50000','電腦斷層攝影是一種結合X光與電腦科技的診斷工具，利用電腦將資料組合成身體橫切面的影像，這些橫切面的影像可再進一步重組成精細的3D立體影像。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','肺臟功能檢測機',SYSDATE,'5000','進階肺功能測試報告。肺臟年齡評估可做激發測試迎接遠端醫療應用。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','手臂式血壓計',SYSDATE,'4500','雙麥克風裝置 - 左右兩側內裝可清晰聽取動脈音的高感度麥克風，聽左、右手臂皆可測量。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','血氣濃度機',SYSDATE,'3000','基本上血氣濃度機會與血壓器一同出現檢查體內血小板 紅血球濃度','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','抗力球',SYSDATE,'500','抗力球跟一般健身一樣，必須靠著各種練習動作的反覆及設計組合，利用抗力球的輔助，做起來不僅不會那麼沉悶，有趣又有效的運動。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','訓練棒',SYSDATE,'1200','全方位手部訓練器著重在手腕的肌力訓練，360度的把手運轉及可調的阻力設計，讓手部的肌肉訓練亦可拉伸，同時可用來做扶地挺身。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','煞車滑輪',SYSDATE,'2000','鍛鍊腹肌、背部、手臂和上半身,肌群健身運動最佳輔助用具','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','耳溫槍',SYSDATE,'1365','耳溫槍為一般民眾常使用的醫療儀器之一，操作方法簡便並能快速得到數據，所以逐漸取代了舊式水銀體溫計的使用。為在耳溫槍量測中得到較為準確的數據，需要正確的儀器操作、清潔、儲存及定期校正。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','呼吸器',SYSDATE,'1707','呼吸器為醫院內的急診室及加護病房內常見之醫療儀器，當病患本身無法自行呼吸或是可自行呼吸但無法達到人體所需之氧氣濃度時，需加裝呼吸器以維持生命，例如SARS、H1N1等肺部病變之病患或是肺部受創者。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','心電圖機',SYSDATE,'8600','心臟是由具有自發性跳動及節律性收縮的肌肉組成。當心肌在活動時，就會有電流產生，經過心臟周圍的導電組織與體液反映到身體表面，運用微電極技術把心臟組織電壓變化記錄成圖形就是心電圖。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000002','雙人加大舒適充氣床墊',SYSDATE,'5500','充氣床墊的「理想」充氣方式為「中等」充氣（0.02BAR或0.3PSI），其當坐在充氣床上時感覺到臀部接觸地面。一旦躺在床墊上，空氣能平均支撐身體，達到良好的舒適度。推薦使用充氣筒：「Quechua 5.2 公升紅色」 (8243066) 產品系列中最有效率的充氣筒。','08078708545405','U','A');
...
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000001','工具斧頭錘',SYSDATE,'1707','該鉗集多種功能於一體,以一抵十幾，是居家，戶外野營的好幫手。邊角採用磨邊處理，而且直刃刀，木工鋸，螺絲刀，開罐瓶器等所有工具，可以在不打開整個工具的前提下直接打開使用，使用更加方便快捷。一把多能鉗幾乎包含了日常和野外作業所需的所有工具，工具配有專用套以便隨身攜帶。','08078708545405','U','A');
...
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000001','防潮墊',SYSDATE,'480','雙面鍍箔具有防潮，耐磨，新型XPE材質無毒、無異味，厚約0.25mm。有一定厚度，適合帳篷、野餐、露營等使用。','08078708545405','U','A');
...
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000001','全功能名片型瑞士刀',SYSDATE,'500','是為了符合現代多功能需求特性而設計的：多達13種的功能，外型如用信用卡般大小，厚度僅0.45公分，可適用於各類皮夾、名片夾、萬用手冊之內，隨身攜帶、方便使用！','08078708545405','U','A');
...
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000001','不鏽鋼長直刀',SYSDATE,'1707','專為戶外探險設計的全方位刀具，高品質、高銳利度以及較長的使用壽命,耐衝擊力的黑色握柄，人體工學設計，搭配高度摩擦的止滑橡膠握把，讓刀柄更容易去抓握及使用，具備力道與精準度。','08078708545405','U','A');
insert into GOODS_SELL(GS_NO,MF_NO,GS_NAME,GS_DATE,GS_PRICE,GS_INFO,GS_IMG,GS_STA,GS_TYPE) values ('GS'||LPAD(GS_NO_SQ.nextval,8,0),'MM00000001','野營斧頭暨直刀組',SYSDATE,'3560','直刀與斧頭的組合，能夠滿足多數戶外使用需求，也頗受木工、電工和建築工人的喜愛,直刀採用瑞典冷軋特殊不銹鋼刀刃，經過特殊的熱處理及硬化，打造出無與倫比的性能，特別設計的刀身角度，適合多功能的用途。','08078708545405','U','A');
