...
INSERT INTO BUY_RECORD(BR_ID,MEM_NO,BR_DATE,BR_CASH)
      VALUES('BR' || LPAD(BR_NO_SQ.NEXTVAL, 8, '0'),'MG00000001','18-1月-09',500);

INSERT INTO BUY_RECORD(BR_ID,MEM_NO,BR_DATE,BR_CASH)
      VALUES('BR' || LPAD(BR_NO_SQ.NEXTVAL, 8, '0'),'MG00000001','18-4月-09',1000);

INSERT INTO BUY_RECORD(BR_ID,MEM_NO,BR_DATE,BR_CASH)
      VALUES('BR' || LPAD(BR_NO_SQ.NEXTVAL, 8, '0'),'MG00000002','12-12月-09',500);
...
INSERT INTO Advertisement(AD_NO,MF_NO,AD_SELF,AD_PHOTO,DAY_START,DAY_END,AD_CASH,AD_STA)
	VALUES('AD' || LPAD(AD_NO_SQ.NEXTVAL, 8, '0'),'MM00000002','b歌折扣!!',null,'01-1月-12','01-1月-15',150000,'U');
INSERT INTO Advertisement(AD_NO,MF_NO,AD_SELF,AD_PHOTO,DAY_START,DAY_END,AD_CASH,AD_STA)
	VALUES('AD' || LPAD(AD_NO_SQ.NEXTVAL, 8, '0'),'MM00000001','A全牛奶買一送一大折扣!!',null,'03-8月-12','01-4月-15',150000,'U');
