...
insert into ORDERDE_DETAIL (ORDERDE_DETAILNO,PICNIC_NO,P_NO,GS_NO,OD_AMOUNT,OD_PRICE,OD_DELIVER,OD_PLACE,OD_BS)values('OD'||LPAD(ORDERDE_DETAIL_SQ.nextval,'8','0'),'PG00000001','P000000001','GS00000001','4','4564575',SYSDATE,' 972花蓮縣秀林鄉富世村富世291號','U');
insert into ORDERDE_DETAIL (ORDERDE_DETAILNO,PICNIC_NO,P_NO,GR_NO,OD_AMOUNT,OD_PRICE,OD_DELIVER,OD_PLACE,OD_BS)values('OD'||LPAD(ORDERDE_DETAIL_SQ.nextval,'8','0'),'PG00000001','P000000001','GR00000002','4','4564575',SYSDATE,'972花蓮縣秀林鄉富世村富世291號','U');
