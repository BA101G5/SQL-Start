...
INSERT INTO PICNIC(PICNIC_NO, PICNIC_NAME, PICNIC_STARTUP, PICNIC_SETUP, PICNIC_CHK, PICNIC_DATE, PICNIC_PL, PICNIC_STA, ORD_TOTAL, ORD_DM, ORD_STA)
VALUES('PG' || LPAD(PICNIC_NO_SQ.NEXTVAL, 8, '0'), '等離子隊', SYSDATE, ADD_MONTHS(SYSDATE, 1), 'Y', ADD_MONTHS(SYSDATE, 2), 5, 'S', 0, 'unknown', 'S');
INSERT INTO PICNIC(PICNIC_NO, PICNIC_NAME, PICNIC_STARTUP, PICNIC_SETUP, PICNIC_CHK, PICNIC_DATE, PICNIC_PL, PICNIC_STA, ORD_TOTAL, ORD_DM, ORD_STA)
VALUES('PG' || LPAD(PICNIC_NO_SQ.NEXTVAL, 8, '0'), '海洋隊', SYSDATE, ADD_MONTHS(SYSDATE, 1), 'Y', ADD_MONTHS(SYSDATE, 2), 30, 'S', 0, 'unknown', 'S');
INSERT INTO PICNIC(PICNIC_NO, PICNIC_NAME, PICNIC_STARTUP, PICNIC_SETUP, PICNIC_CHK, PICNIC_DATE, PICNIC_PL, PICNIC_STA, ORD_TOTAL, ORD_DM, ORD_STA)
VALUES('PG' || LPAD(PICNIC_NO_SQ.NEXTVAL, 8, '0'), '火岩隊', SYSDATE, ADD_MONTHS(SYSDATE, 1), 'Y', ADD_MONTHS(SYSDATE, 2), 5, 'S', 0, 'unknown', 'S');
INSERT INTO PICNIC(PICNIC_NO, PICNIC_NAME, PICNIC_STARTUP, PICNIC_SETUP, PICNIC_CHK, PICNIC_DATE, PICNIC_PL, PICNIC_STA, ORD_TOTAL, ORD_DM, ORD_STA)
VALUES('PG' || LPAD(PICNIC_NO_SQ.NEXTVAL, 8, '0'), '銀河隊', SYSDATE, ADD_MONTHS(SYSDATE, 1), 'Y', ADD_MONTHS(SYSDATE, 2), 3, 'S', 0, 'unknown', 'S');
INSERT INTO PICNIC(PICNIC_NO, PICNIC_NAME, PICNIC_STARTUP, PICNIC_SETUP, PICNIC_CHK, PICNIC_DATE, PICNIC_PL, PICNIC_STA, ORD_TOTAL, ORD_DM, ORD_STA)
VALUES('PG' || LPAD(PICNIC_NO_SQ.NEXTVAL, 8, '0'), '火箭隊', SYSDATE, ADD_MONTHS(SYSDATE, 1), 'Y', ADD_MONTHS(SYSDATE, 2), 1, 'S', 0, 'unknown', 'S');
COMMIT;
