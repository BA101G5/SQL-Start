...
CONSTRAINT CHATROOM_PICNICNO_FK FOREIGN KEY (PICNIC_NO) REFERENCES PICNIC (PICNIC_NO),
...
INSERT INTO CHATROOM(CHATROOM_NO, PICNIC_NO, CHATROOM_KIND)
VALUES('CR' || LPAD(CHATROOM_NO_SQ.NEXTVAL, 8, '0'), NULL, 'P');
