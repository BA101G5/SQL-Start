...
INSERT INTO BUY_RECORD(BR_ID,MEM_NO,BR_DATE,BR_CASH)
      VALUES('BR' || LPAD(BR_NO_SQ.NEXTVAL, 8, '0'),'MG00000001','18-JAN-09',500);

INSERT INTO BUY_RECORD(BR_ID,MEM_NO,BR_DATE,BR_CASH)
      VALUES('BR' || LPAD(BR_NO_SQ.NEXTVAL, 8, '0'),'MG00000001','18-APR-09',1000);

INSERT INTO BUY_RECORD(BR_ID,MEM_NO,BR_DATE,BR_CASH)
      VALUES('BR' || LPAD(BR_NO_SQ.NEXTVAL, 8, '0'),'MG00000002','12-DEC-09',500);
